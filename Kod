...
class Ball(Block):
	...
	def update(self):
		...
		# Зіткнення кулі із стінками або об'єктом
	def collisions(self):
    ...
    # Відлік часу для викидання м'ча
...
bg_color = pygame.Color('#2F472F')
accent_color = (27,15,43)
basic_font = pygame.font.Font('freesansbold.ttf', 40)
plob_sound = pygame.mixer.Sound("pong.ogg")
score_sound = pygame.mixer.Sound("score.ogg")
middle_strip = pygame.Rect(screen_width/2 - 2,0,5,screen_height)
